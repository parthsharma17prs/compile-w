            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="mt-4 flex gap-8 items-center text-accent-blue/50 font-bebas text-2xl uppercase tracking-[1em]"
                    >
                        <span>VERIFYING</span>
                ...
                <motion.div
                    ...
                    className="absolute inset-0 bg-accent-blue rounded-full blur-[150px] -z-10"
                />
            </div>
        </section>
    );
